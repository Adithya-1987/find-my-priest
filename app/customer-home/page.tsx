        ...
        <section className="py-12 bg-card/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { name: 'Griha Pravesh', icon: '🏠', count: 234 },
                { name: 'Satyanarayan Pooja', icon: '🙏', count: 189 },
                { name: 'Wedding Ceremony', icon: '💑', count: 156 },
                { name: 'Baby Naming', icon: '👶', count: 98 },
                { name: 'Last Rites', icon: '🕉️', count: 76 },
                { name: 'Navagraha Pooja', icon: '🪐', count: 65 },
                { name: 'Vastu Shanti', icon: '🏡', count: 54 },
                { name: 'Mundan Ceremony', icon: '👦', count: 43 }
              ].map((ceremony) => (
