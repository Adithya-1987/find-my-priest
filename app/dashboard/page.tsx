                    ...
                    <div key={booking.id} className="bg-card rounded-xl p-6 border border-border hover:shadow-lg transition-all">
                      <div className="flex flex-col sm:flex-row justify-between gap-4">
                        <div className="flex gap-4">
                          ...
                          <div>
                            <h3 className="font-semibold text-foreground mb-1">{booking.ceremony}</h3>
                  ...
                  <div className="flex justify-between items-start gap-4">
                    <div className="flex gap-4 flex-1">
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${
                        ...
                        {
                          notification.type === 'booking' ? <Calendar className="text-blue-600" size={20} /> :
                          notification.type === 'reminder' ? <Bell className="text-orange-600" size={20} /> :
                          notification.type === 'review' ? <Star className="text-green-600" size={20} /> :
      ...
      >
        <div className="space-y-6">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-foreground mb-1">{selectedBooking?.ceremony}</h3>
