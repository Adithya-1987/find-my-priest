...
function AppProvider({ children }) {
    ...
    const showToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[showToast]": (type, message, duration = 4000)=>{
            const id = Math.random().toString(36).substr(2, 9);
            setToasts({
                "AppProvider.useCallback[showToast]": (prev)=>[
                        ...prev,
                        {
                            id,
                            type,
            ...
            }["AppProvider.useCallback[showToast]"]);
            if (duration > 0) {
                setTimeout({
                    "AppProvider.useCallback[showToast]": ()=>{
                        setToasts({
                            "AppProvider.useCallback[showToast]": (prev)=>prev.filter({
                                    "AppProvider.useCallback[showToast]": (t)=>t.id !== id
                                }["AppProvider.useCallback[showToast]"])
                        }["AppProvider.useCallback[showToast]"]);
                    }
                }["AppProvider.useCallback[showToast]"], duration);
            }
        }
    }["AppProvider.useCallback[showToast]"], []);
    const removeToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[removeToast]": (id)=>{
            setToasts({
                "AppProvider.useCallback[removeToast]": (prev)=>prev.filter({
                        "AppProvider.useCallback[removeToast]": (t)=>t.id !== id
                    }["AppProvider.useCallback[removeToast]"])
            }["AppProvider.useCallback[removeToast]"]);
        }
    }["AppProvider.useCallback[removeToast]"], []);
    const markNotificationAsRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[markNotificationAsRead]": (id)=>{
            setNotifications({
                "AppProvider.useCallback[markNotificationAsRead]": (prev)=>prev.map({
                        "AppProvider.useCallback[markNotificationAsRead]": (n)=>n.id === id ? {
                                ...n,
                                read: true
                            } : n
                    }["AppProvider.useCallback[markNotificationAsRead]"])
            }["AppProvider.useCallback[markNotificationAsRead]"]);
        }
    }["AppProvider.useCallback[markNotificationAsRead]"], []);
    const clearAllNotifications = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[clearAllNotifications]": ()=>{
            setNotifications([]);
        }
    }["AppProvider.useCallback[clearAllNotifications]"], []);
    const value = {
...
_s(AppProvider, "sY4ztHJFftdb8zZoI0BT9Zlqp3I=");
_c = AppProvider;
...
"[project]/components/toast-container.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ToastContainer() {
    _s();
    const { toasts, removeToast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$app$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppContext"])();
...
_s(ToastContainer, "G8ESTlmUL5znRO0VgKcngEUuVDc=", false, function() {
    return [
...
//# sourceMappingURL=_2f72b8d2._.js.map